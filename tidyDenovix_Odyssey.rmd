...
The documentation series is often intended to appreciate myself and by that I mean actively documenting what my initial thoughts were on a solution to what the final thoughts were often achieved by patience in the programming journey. Because programming is not coding, it often means that the initial thought burden is heavier because we must always start programming with the desire to elimination repitition of the workflow whereas coding is forgiving to the mind as the coder has the liberty of repeting the same steps manually over and over again which means hard coding can be forgiven. 
